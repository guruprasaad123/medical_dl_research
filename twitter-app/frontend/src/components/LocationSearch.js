...
export class LocationSearch extends Component {
    ...
    getPlaceSuggestions = (input)=>{
        ...
        axiosInstance.get(`https://maps.googleapis.com/maps/api/place/autocomplete/json?input=${input}&ype=geocode&language=en&key=AIzaSyBuh3nvxDKSq3tlS0kM8x6glR55M5v_9B8`).then((object)=>{
